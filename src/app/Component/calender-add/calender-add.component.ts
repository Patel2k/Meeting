...
import { Room } from 'src/app/Models/room/room.module';
import { TimeList } from 'src/app/Models/time-list/time-list.module';
...
export class CalenderAddComponent {
  ...
  saveBooking() {
    debugger;
    this.myService.addMeeting(this.meetinglist).subscribe((meet:any) => {
